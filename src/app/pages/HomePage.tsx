      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 py-20 md:py-28">
        <RevealSection>
          <div className="flex items-end justify-between mb-12">
            ...
            <Link to="/shop" className="hidden md:flex items-center gap-2 text-xs tracking-[0.2em] uppercase hover:gap-4 transition-all duration-300">
        ...
        <div className="text-center mt-12 md:hidden">
          <Link to="/shop" className="inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase border border-black px-8 py-3 hover:bg-black hover:text-white transition-all duration-300">
            Xem tất cả <ArrowRight size={14} />
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 py-20 md:py-28">
        <RevealSection>
          <div className="flex items-end justify-between mb-12">
            ...
            <Link to="/blog" className="hidden md:flex items-center gap-2 text-xs tracking-[0.2em] uppercase hover:gap-4 transition-all duration-300">
